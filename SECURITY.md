...
Use the
[form0-connector-sqlite private vulnerability report](https://github.com/paqu-io/form0-connector-sqlite/security/advisories/new).
...
[SUPPORT.md](https://github.com/paqu-io/form0-connector-sqlite/blob/main/SUPPORT.md).
